...
if(isset($_GET['Id'])||isset($_GET['id'])){
	...
	$sql="select Id,Name, Price, Quantity, Description,Brand, Type, Image,Availability,Code from ciate_london where Id = $Id";
	...
	<hr class="dash">
	  ...
	  <div class="container mt-4 blog-card">
        ...
        <div class="row">
			...
			<form method="post" action="viewdetailss2.php?action=add&id=<?php echo $result["Id"]; ?>">
