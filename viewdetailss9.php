...
if(isset($_GET['Id'])||isset($_GET['id'])){
	...
	$sql="select Id,Name, Price, Quantity, Description,Brand, Type, Image,Availability,Code from lee_stafford where Id = $Id";
	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="leestafordpage.php"</script>';
			}
		}
	}
	...
	<hr class="dash">
	  ...
	  <div class="container mt-4 blog-card">
        ...
        <div class="row">
			...
			<form method="post" action="viewdetailss9.php?action=add&id=<?php echo $result["Id"]; ?>">
                <div class="product-information"><!--/product-information-->
						...
						<input type="hidden" name="hidden_price" value="<?php echo $result["Price"]; ?>" />
									...
									<input type="submit" name="add_to_cart" style="margin-top:5px;" class="btn btn-success" onClick="location.href:='viewdetailss9.php?Id=<?php echo $result['Id']?>'" value="Add to Cart" />
