...
//echo 'What is life?'.$_GET['id'].'sotto';
...
if(isset($_GET['Id'])||isset($_GET['id'])){
	...
	$sql="select Id,Name, Price, Quantity, Description,Brand, Type, Image,Availability,Code from salon_science where Id = $Id";
...
{
	echo 'buke betha, loke bole gastik '.$_GET["id"];
	...
	<hr class="dash">
	  ...
	  <div class="container mt-4 blog-card">
        ...
        <div class="row">
			...
			<form method="post" action="viewdetailss1.php?action=add&id=<?php echo $result["Id"]; ?>">
                <div class="product-information"><!--/product-information-->
						...
						<input type="hidden" name="hidden_price" value="<?php echo $result["Price"]; ?>" />
									...
									<input type="submit" name="add_to_cart" style="margin-top:5px;" class="btn btn-success" onClick="location.href:='viewdetailss1.php?Id=<?php echo $result['Id']?>'" value="Add to Cart" />
