...
if(isset($_GET['Id'])||isset($_GET['id'])){
	...
	$sql="select Id,Name, Price, Quantity, Description,Brand, Type, Image,Availability,Code from exclusive_product where Id = $Id";
	...
	<hr class="dash">
	  ...
	  <div class="container mt-4 blog-card">
        ...
        <div class="row">
			...
			<form method="post" action="viewdetailss10.php?action=add&id=<?php echo $result["Id"]; ?>">
                <div class="product-information"><!--/product-information-->
						...
						<input type="hidden" name="hidden_price" value="<?php echo $result["Price"]; ?>" />
									...
									<input type="submit" name="add_to_cart" style="margin-top:5px;" class="btn btn-success" onClick="location.href:='viewdetailss10.php?Id=<?php echo $result['Id']?>'" value="Add to Cart" />
